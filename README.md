...
- **[NSwag.Core](https://www.nuget.org/packages/NSwag.Core/)** [![Apiverse](https://img.shields.io/badge/NSwag.Core%20API-apiverse.io-1dce73.svg)](https://apiverse.io/organizations/nuget-org/nuget-feeds/public/packages/NSwag.Core/versions/latest?tab=types&type=NSwag.OpenApiDocument) (.NET Standard 1.0 / 2.0 and .NET 4.5)
