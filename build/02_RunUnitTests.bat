vstest.console /logger:Appveyor "%~dp0../src/NSwag.OpenApiGeneration.WebApi.Tests/bin/Release/NSwag.OpenApiGeneration.WebApi.Tests.dll" || goto :error
...
dotnet test "%~dp0/../src/NSwag.OpenApiGeneration.AspNetCore.Tests/NSwag.OpenApiGeneration.AspNetCore.Tests.csproj" -c Release || goto :error
