...
namespace NSwag.CodeGeneration.TypeScript.Tests
{
    public class AngularJSTests
    {
        ...
        public async Task When_use_base_http_client_true_then_do_not_add_instance()
        {
            ...
            // Assert
            Assert.DoesNotContain("private http: ng.IHttpService", code);
            Assert.DoesNotContain("$http: ng.IHttpService, ", code);
        ...
        public async Task When_not_use_base_http_client_false_then_do_add_instance()
        {
            ...
            // Assert
            Assert.Contains("private http: ng.IHttpService", code);
            Assert.Contains("$http: ng.IHttpService, ", code);
