...
namespace NSwag.CodeGeneration.CodeGenerators.Models
{
    ...
    public abstract class ResponseModelBase
    {
        ...
        protected ResponseModelBase(string statusCode, SwaggerResponse response, JsonSchema4 exceptionSchema, bool isSuccessResponse, CodeGeneratorSettingsBase settings, IClientGenerator generator)
        {
            _response = response;
