...
namespace NSwag.CodeGeneration.OperationNameGenerators
{
    ...
    public interface IOperationNameGenerator
    {
        ...
        string GetClientName(SwaggerDocument document, string path, string httpMethod, OpenApiOperation operation);
        ...
        string GetOperationName(SwaggerDocument document, string path, string httpMethod, OpenApiOperation operation);
    }
}