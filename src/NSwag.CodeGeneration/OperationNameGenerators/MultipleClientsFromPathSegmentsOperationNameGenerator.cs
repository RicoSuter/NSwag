...
namespace NSwag.CodeGeneration.OperationNameGenerators
{
    ...
    public class MultipleClientsFromPathSegmentsOperationNameGenerator : IOperationNameGenerator
    {
        ...
        public virtual string GetClientName(SwaggerDocument document, string path, string httpMethod, OpenApiOperation operation)
        {
            return path
                .Split('/')
        ...
        /// <param name="operation">The operation.</param>
        /// <returns>The client name.</returns>
        public virtual string GetOperationName(SwaggerDocument document, string path, string httpMethod, OpenApiOperation operation)
        {
