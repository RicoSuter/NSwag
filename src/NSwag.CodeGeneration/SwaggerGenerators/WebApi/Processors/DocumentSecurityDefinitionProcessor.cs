//-----------------------------------------------------------------------
// <copyright file="DocumentSecurityDefinitionProcessor.cs" company="NSwag">
...
namespace NSwag.CodeGeneration.SwaggerGenerators.WebApi.Processors
{
    ...
    public class DocumentSecurityDefinitionProcessor : IDocumentProcessor
    {
        private readonly string _name;
        private readonly SwaggerSecurityScheme _swaggerSecurityScheme;

        /// <summary>Initializes a new instance of the <see cref="DocumentSecurityDefinitionProcessor" /> class.</summary>
        ...
        public DocumentSecurityDefinitionProcessor(string name, SwaggerSecurityScheme swaggerSecurityScheme)
        {
            _name = name; 
