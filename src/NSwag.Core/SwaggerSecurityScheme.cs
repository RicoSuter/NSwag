...
namespace NSwag
{
    ...
    public class SwaggerSecurityScheme : JsonExtensionObject
    {
        ...
        /// <summary>Gets or sets the name of the HTTP Authorization scheme to be used in the Authorization header as defined in RFC7235.</summary>
        [JsonProperty(PropertyName = "scheme", DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate)]
        public string Scheme { get; set; }

        /// <summary>Gets or sets the hint to the client to identify how the bearer token is formatted. Bearer tokens are usually generated by an authorization server, so this information is primarily for documentation purposes.</summary>
