...
namespace PetStore
{
    ...
    public partial class PetStoreClient 
    {
        ...
        public async System.Threading.Tasks.Task AddPetAsync(Pet body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "405") 
                {
                    throw new SwaggerException("Invalid input", status_, response_, null);
                }
                else
        ...
        public async System.Threading.Tasks.Task UpdatePetAsync(Pet body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid ID supplied", status_, response_, null);
                }
                else
                if (status_ == "404") 
                {
                    throw new SwaggerException("Pet not found", status_, response_, null);
                }
                else
                if (status_ == "405") 
                {
                    throw new SwaggerException("Validation exception", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Pet>> FindPetsByStatusAsync(System.Collections.Generic.IEnumerable<Anonymous> status, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid status value", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Pet>> FindPetsByTagsAsync(System.Collections.Generic.IEnumerable<string> tags, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid tag value", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<Order> PlaceOrderAsync(Order body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid Order", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<Order> GetOrderByIdAsync(long orderId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "404") 
                {
                    throw new SwaggerException("Order not found", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<string> LoginUserAsync(string username, string password, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid username/password supplied", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<User> GetUserByNameAsync(string username, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid username supplied", status_, response_, null);
                }
                else
                if (status_ == "404") 
                {
                    throw new SwaggerException("User not found", status_, response_, null);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task UpdateUserAsync(string username, User body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "400") 
                {
                    throw new SwaggerException("Invalid user supplied", status_, response_, null);
                }
                else
                if (status_ == "404") 
                {
    ...
    public class SwaggerException : System.Exception
    {
        ...
        public SwaggerException(string message, string statusCode, System.Net.Http.HttpResponseMessage response, System.Exception innerException) 
    ...
    public class SwaggerException<TResult> : SwaggerException
    {
        ...
        public SwaggerException(string message, string statusCode, System.Net.Http.HttpResponseMessage responseData, TResult result, System.Exception innerException) 
