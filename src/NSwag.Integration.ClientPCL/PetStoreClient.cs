...
namespace PetStore
{
    ...
    public partial class PetStoreClient : IPetStoreClient
    {
        ...
        /// <param name="body">Pet object that needs to be added to the store</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        protected System.Threading.Tasks.Task AddPetAsync(Pet body)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        protected async System.Threading.Tasks.Task AddPetAsync(Pet body, System.Threading.CancellationToken cancellationToken)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "8.4.6254.24648")]
