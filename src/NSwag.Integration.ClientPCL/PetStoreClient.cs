...
namespace PetStore
{
    ...
    public partial class PetStoreClient : IPetStoreClient
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Pet>> FindPetsByStatusAsync(System.Collections.Generic.IEnumerable<Anonymous> status, System.Threading.CancellationToken cancellationToken)
        {
            ...
            foreach (var item_ in status) { urlBuilder_.Append("status=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Pet>> FindPetsByTagsAsync(System.Collections.Generic.IEnumerable<string> tags, System.Threading.CancellationToken cancellationToken)
        {
            ...
            foreach (var item_ in tags) { urlBuilder_.Append("tags=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<Pet> GetPetByIdAsync(long petId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Replace("{petId}", System.Uri.EscapeDataString(ClientUtilities.ConvertToString(petId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task UpdatePetWithFormAsync(long petId, string name, string status, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (name != null)
                        content_.Add(new System.Net.Http.StringContent(ClientUtilities.ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture)), "name");
                    if (status != null)
                        content_.Add(new System.Net.Http.StringContent(ClientUtilities.ConvertToString(status, System.Globalization.CultureInfo.InvariantCulture)), "status");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
        ...
        public async System.Threading.Tasks.Task DeletePetAsync(string api_key, long petId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    request_.Headers.TryAddWithoutValidation("api_key", api_key != null ? ClientUtilities.ConvertToString(api_key, System.Globalization.CultureInfo.InvariantCulture) : null);
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (additionalMetadata != null)
                        content_.Add(new System.Net.Http.StringContent(ClientUtilities.ConvertToString(additionalMetadata, System.Globalization.CultureInfo.InvariantCulture)), "additionalMetadata");
                    if (file != null)
        ...
        public async System.Threading.Tasks.Task<Order> GetOrderByIdAsync(long orderId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Replace("{orderId}", System.Uri.EscapeDataString(ClientUtilities.ConvertToString(orderId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task<string> LoginUserAsync(string username, string password, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("username=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(username, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("password=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(password, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<User> GetUserByNameAsync(string username, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Replace("{username}", System.Uri.EscapeDataString(ClientUtilities.ConvertToString(username, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.10.15.0 (Newtonsoft.Json v9.0.0.0)")]
