//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v11.1.2.0 (NJsonSchema v9.2.3.0) (http://NSwag.org)
// </auto-generated>
//----------------------
...
namespace PetStore
{
    ...
    public partial class PetStoreClient : IPetStoreClient
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Pet>> FindPetsByStatusAsync(System.Collections.Generic.IEnumerable<Anonymous> status, System.Threading.CancellationToken cancellationToken)
        {
            ...
            foreach (var item_ in status) { urlBuilder_.Append("status=").Append(System.Uri.EscapeDataString(System.Convert.ToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Pet>> FindPetsByTagsAsync(System.Collections.Generic.IEnumerable<string> tags, System.Threading.CancellationToken cancellationToken)
        {
            ...
            foreach (var item_ in tags) { urlBuilder_.Append("tags=").Append(System.Uri.EscapeDataString(System.Convert.ToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<Pet> GetPetByIdAsync(long petId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/pet/{petId}");
            urlBuilder_.Replace("{petId}", System.Uri.EscapeDataString(System.Convert.ToString(petId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public async System.Threading.Tasks.Task UpdatePetWithFormAsync(long petId, string name, string status, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (name != null)
                            content_.Add(new System.Net.Http.StringContent(System.Convert.ToString(name, System.Globalization.CultureInfo.InvariantCulture)), "name");
                    if (status != null)
                            content_.Add(new System.Net.Http.StringContent(System.Convert.ToString(status, System.Globalization.CultureInfo.InvariantCulture)), "status");
                    request_.Content = content_;
                    request_.Method = new System.Net.Http.HttpMethod("POST");
        ...
        public async System.Threading.Tasks.Task<ApiResponse> UploadFileAsync(long petId, string additionalMetadata, FileParameter file, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/pet/{petId}/uploadImage");
            urlBuilder_.Replace("{petId}", System.Uri.EscapeDataString(System.Convert.ToString(petId, System.Globalization.CultureInfo.InvariantCulture)));
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (additionalMetadata != null)
                            content_.Add(new System.Net.Http.StringContent(System.Convert.ToString(additionalMetadata, System.Globalization.CultureInfo.InvariantCulture)), "additionalMetadata");
                    if (file != null)
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/store/inventory");
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/store/order");
        ...
        public async System.Threading.Tasks.Task<Order> GetOrderByIdAsync(long orderId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/store/order/{orderId}");
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/user/createWithArray");
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/user/createWithList");
        ...
        public async System.Threading.Tasks.Task<string> LoginUserAsync(string username, string password, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/user/login?");
            urlBuilder_.Append("username=").Append(System.Uri.EscapeDataString(System.Convert.ToString(username, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("password=").Append(System.Uri.EscapeDataString(System.Convert.ToString(password, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/user/logout");
        ...
        public async System.Threading.Tasks.Task<User> GetUserByNameAsync(string username, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl).Append("/user/{username}");
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.2.3.0")]
