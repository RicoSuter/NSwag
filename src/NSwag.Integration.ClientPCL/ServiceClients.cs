//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v8.7.6228.20079 (NJsonSchema v7.6.6221.22528) (http://NSwag.org)
// </auto-generated>
//----------------------
...
namespace NSwag.Integration.ClientPCL
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "8.7.6228.20079")]
    public partial class GeoClient : ClientBase
    {
        ...
        public async System.Threading.Tasks.Task FromBodyTestAsync(GeoPoint location, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                if (status_ != "200" && status_ != "204")
                    throw new GeoClientException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
            }
        }
                ...
                if (status_ == "200") 
                {
                    ...
                    try
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<string>>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length), new Newtonsoft.Json.JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter(), new JsonExceptionConverter() });                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
                        throw new GeoClientException("Could not deserialize the response body.", status_, response_, exception);
                    }
                }
                else
                if (status_ != "200" && status_ != "204")
        ...
        public async System.Threading.Tasks.Task SaveItemsAsync(GenericRequestOfAddressAndPerson request, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                if (status_ == "450") 
                {
                    ...
                    throw new GeoClientException<System.Exception>("A custom error occured.", status_, response_, result_, result_);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new GeoClientException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        /// <exception cref="GeoClientException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.IO.Stream> GetUploadedFileAsync(int id, bool? @override)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="GeoClientException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetUploadedFileAsync(int id, bool? @override, System.Threading.CancellationToken cancellationToken)
        {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Person>> GetAllAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        throw new PersonsClientException("Could not deserialize the response body.", status_, response_, exception);
                    }
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new PersonsClientException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<Person> GetAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = await CreateHttpClientAsync(cancellationToken).ConfigureAwait(false))
            {
                ...
                if (status_ == "500") 
                {
                    ...
                    result_.Data.Add("HttpStatus", status_);
                    result_.Data.Add("ResponseData", System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));
                    throw new PersonsClientException<PersonNotFoundException>("A server side error occurred.", status_, response_, result_, result_);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new PersonsClientException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
