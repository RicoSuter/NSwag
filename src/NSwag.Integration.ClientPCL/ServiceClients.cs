...
namespace NSwag.Integration.WebAPI
{
    ...
    [GeneratedCode("NSwag", "5.6.6107.656")]
    public partial class GeoClient 
    {
        ...
        public async Task SaveItemsAsync(GenericRequestOfAddressAndPerson request, CancellationToken cancellationToken)
        {
            ...
            if (status_ == "500") 
            {
                ...
                throw new SwaggerException<Exception>("A server side error occurred.", status_, responseData_, result_, result_);
            }
            else
            {
            }
    ...
    [GeneratedCode("NJsonSchema", "4.12.6107.656")]
