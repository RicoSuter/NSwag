...
namespace NSwag.Integration.WebAPI
{
    ...
    [GeneratedCode("NSwag", "5.6.6106.36126")]
    public partial class GeoClient 
    {
        ...
        public async Task FromBodyTestAsync(GeoPoint location, CancellationToken cancellationToken)
        {
            ...
            var content_ = new StringContent(JsonConvert.SerializeObject(location, new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() }));
        ...
        public async Task AddPolygonAsync(IEnumerable<GeoPoint> points, CancellationToken cancellationToken)
        {
            ...
            var content_ = new StringContent(JsonConvert.SerializeObject(points, new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() }));
            content_.Headers.ContentType.MediaType = "application/json";
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public Task UploadFileAsync(FileParameter file)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async Task UploadFileAsync(FileParameter file, CancellationToken cancellationToken)
        {
        ...
        public async Task SaveItemsAsync(GenericRequestOfAddressAndPerson request, CancellationToken cancellationToken)
        {
            ...
            var content_ = new StringContent(JsonConvert.SerializeObject(request, new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() }));
            content_.Headers.ContentType.MediaType = "application/json";
    ...
    public partial class PersonsClient 
    {
            ...
            if (status_ == "200") 
            {
                ...
                try
                {
                    if (responseData_.Length > 0)
                        result_ = JsonConvert.DeserializeObject<ObservableCollection<Person>>(Encoding.UTF8.GetString(responseData_, 0, responseData_.Length), new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });                                
                    return result_; 
                } 
        ...
        public async Task AddAsync(Person person, CancellationToken cancellationToken)
        {
            ...
            var content_ = new StringContent(JsonConvert.SerializeObject(person, new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() }));
            content_.Headers.ContentType.MediaType = "application/json";
        ...
        public async Task<Person> GetAsync(Guid id, CancellationToken cancellationToken)
        {
            ...
            if (status_ == "200") 
            {
                ...
                {
                    if (responseData_.Length > 0)
                        result_ = JsonConvert.DeserializeObject<Person>(Encoding.UTF8.GetString(responseData_, 0, responseData_.Length), new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });                                
                    return result_; 
                } 
                catch (Exception exception) 
                {
            ...
            if (status_ == "500") 
            {
                ...
                {
                    if (responseData_.Length > 0)
                        result_ = JsonConvert.DeserializeObject<PersonNotFoundException>(Encoding.UTF8.GetString(responseData_, 0, responseData_.Length), new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });                                
                } 
                catch (Exception exception) 
                {
                    throw new SwaggerException("Could not deserialize the response body.", status_, responseData_, exception);
        ...
        public async Task<string> GetNameAsync(Guid id, CancellationToken cancellationToken)
        {
            ...
            if (status_ == "200") 
            {
                ...
                {
                    if (responseData_.Length > 0)
                        result_ = JsonConvert.DeserializeObject<string>(Encoding.UTF8.GetString(responseData_, 0, responseData_.Length), new JsonConverter[] { new Newtonsoft.Json.Converters.StringEnumConverter() });                                
                    return result_; 
                } 
                catch (Exception exception) 
                {
    ...
    [GeneratedCode("NJsonSchema", "4.12.6106.36125")]
