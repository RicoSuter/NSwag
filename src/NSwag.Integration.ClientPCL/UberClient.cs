    ...
    public partial class Client 
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Product>> ProductsAsync(double latitude, double longitude, System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                else
                {
                    ...
                    {
                        throw new SwaggerException("Could not deserialize the response body.", status_, response_, exception_);
                    }
    
                    throw new SwaggerException<Error>("Unexpected error", status_, response_, result_, null);
                }
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<PriceEstimate>> PriceAsync(double start_latitude, double start_longitude, double end_latitude, double end_longitude, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (start_latitude == null)
                ...
                url_ += string.Format("start_latitude={0}&", System.Uri.EscapeDataString(start_latitude.ToString()));
    
            if (start_longitude == null)
                throw new System.ArgumentNullException("start_longitude");
            else
                url_ += string.Format("start_longitude={0}&", System.Uri.EscapeDataString(start_longitude.ToString()));
    
            if (end_latitude == null)
                throw new System.ArgumentNullException("end_latitude");
            else
                url_ += string.Format("end_latitude={0}&", System.Uri.EscapeDataString(end_latitude.ToString()));
    
            if (end_longitude == null)
                throw new System.ArgumentNullException("end_longitude");
            else
                url_ += string.Format("end_longitude={0}&", System.Uri.EscapeDataString(end_longitude.ToString()));
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.ObjectModel.ObservableCollection<PriceEstimate>>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Product>> TimeAsync(double start_latitude, double start_longitude, System.Guid? customer_uuid, string product_id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (customer_uuid != null)
                url_ += string.Format("customer_uuid={0}&", System.Uri.EscapeDataString(customer_uuid.Value.ToString()));
    
            if (product_id != null)
                url_ += string.Format("product_id={0}&", System.Uri.EscapeDataString(product_id.ToString()));
        ...
        public async System.Threading.Tasks.Task<Profile> MeAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            using (var client_ = new System.Net.Http.HttpClient())
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        if (responseData_.Length > 0)
                            result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<Profile>(System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));                                
                        return result_; 
                    } 
                    catch (System.Exception exception) 
                    {
