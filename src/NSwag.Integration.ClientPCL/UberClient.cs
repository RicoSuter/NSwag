...
namespace Uber
{
    ...
    public partial class Client 
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Product>> ProductsAsync(double latitude, double longitude, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("latitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(latitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("longitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(longitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<PriceEstimate>> PriceAsync(double start_latitude, double start_longitude, double end_latitude, double end_longitude, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("start_latitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(start_latitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("start_longitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(start_longitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("end_latitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(end_latitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("end_longitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(end_longitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Product>> TimeAsync(double start_latitude, double start_longitude, System.Guid? customer_uuid, string product_id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("start_latitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(start_latitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Append("start_longitude=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(start_longitude, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (customer_uuid != null) urlBuilder_.Append("customer_uuid=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(customer_uuid, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (product_id != null) urlBuilder_.Append("product_id=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(product_id, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<Activities> HistoryAsync(int? offset, int? limit, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (offset != null) urlBuilder_.Append("offset=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(offset, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            if (limit != null) urlBuilder_.Append("limit=").Append(System.Uri.EscapeDataString(ClientUtilities.ConvertToString(limit, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
