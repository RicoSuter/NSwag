...
namespace MyNamespace
{
    ...
    {
        void FromBodyTestAsync(GeoPoint location);
    
        void FromUriTestAsync(double? latitude, double? longitude);
    
        void AddPolygonAsync(System.Collections.Generic.List<GeoPoint> points);
    
        void FilterAsync(System.Collections.Generic.List<string> currentStates);
    
        System.Collections.Generic.List<string> ReverseAsync(System.Collections.Generic.List<string> values);
    
        void RefreshAsync();
    
        bool UploadFileAsync(byte[] file);
    
        void UploadFilesAsync(System.Collections.Generic.List<byte[]> files);
    
        void SaveItemsAsync(GenericRequestOfAddressAndPerson request);
    
        FileResponse GetUploadedFileAsync(int id, bool? @override);
    ...
    public partial class GeoController : System.Web.Http.ApiController 
    {
        ...
        public void FromBodyTest(GeoPoint location)
        {
            _implementation.FromBodyTestAsync(location);
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/FromUriTest")]
        public void FromUriTest(double? latitude, double? longitude)
        {
            _implementation.FromUriTestAsync(latitude, longitude);
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/AddPolygon")]
        public void AddPolygon(System.Collections.Generic.List<GeoPoint> points)
        {
            _implementation.AddPolygonAsync(points);
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/Filter")]
        public void Filter(System.Collections.Generic.List<string> currentStates)
        {
            _implementation.FilterAsync(currentStates);
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/Reverse")]
        public System.Collections.Generic.List<string> Reverse(System.Collections.Generic.List<string> values)
        {
        ...
        public void Refresh()
        {
            _implementation.RefreshAsync();
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/UploadFile")]
        public bool UploadFile(byte[] file)
        {
            return _implementation.UploadFileAsync(file);
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/UploadFiles")]
        public void UploadFiles(System.Collections.Generic.List<byte[]> files)
        {
            _implementation.UploadFilesAsync(files);
        }
    
        [System.Web.Http.HttpPost, System.Web.Http.Route("api/Geo/SaveItems")]
        public void SaveItems(GenericRequestOfAddressAndPerson request)
        {
            _implementation.SaveItemsAsync(request);
        }
    
        [System.Web.Http.HttpGet, System.Web.Http.Route("api/Geo/GetUploadedFile/{id}")]
        public FileResponse GetUploadedFile(int id, bool? @override)
        {
    ...
    {
        System.Collections.Generic.List<Person> GetAllAsync();
    
        void AddAsync(Person person);
    
        System.Collections.Generic.List<Person> FindAsync(Gender gender);
    
        System.Collections.Generic.List<Person> FindOptionalAsync(Gender? gender);
    
        Person GetAsync(System.Guid id);
    
        void DeleteAsync(System.Guid id);
    
        Person ThrowAsync(System.Guid id);
    
        /// <summary>Gets the name of a person.</summary>
        /// <param name="id">The person ID.</param>
        /// <returns>The person's name.</returns>
        string GetNameAsync(System.Guid id);
    
        string AddXmlAsync(string person);
    ...
    public partial class PersonsController : System.Web.Http.ApiController 
    {
        ...
        public Person Throw(System.Guid id)
        {
        ...
        public string AddXml(string person)
        {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "7.7.6231.35489")]
