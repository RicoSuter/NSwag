...
namespace NSwag.Integration.Console
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "11.18.7.0 (NJsonSchema v9.10.71.0 (Newtonsoft.Json v9.0.0.0))")]
    public partial class GeoClient 
    {
        ...
        public async System.Threading.Tasks.Task FilterAsync(System.Collections.Generic.IEnumerable<string> currentStates, System.Threading.CancellationToken cancellationToken)
        {
            ...
            {
                foreach (var item_ in currentStates) { urlBuilder_.Append("currentStates=").Append(System.Uri.EscapeDataString(ConvertToString(item_, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
            }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<FileResponse> GetUploadedFileAsync(int id, bool? @override, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (@override != null) 
            {
                urlBuilder_.Append("override=").Append(System.Uri.EscapeDataString(ConvertToString(@override, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
