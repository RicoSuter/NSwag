...
namespace NSwag.Integration.Console
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "9.12.6298.16247")]
    public partial class GeoClient 
    {
        ...
        public async System.Threading.Tasks.Task FromUriTestAsync(double? latitude, double? longitude, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("Latitude=").Append(System.Uri.EscapeDataString(latitude.Value.ToString())).Append("&");
            urlBuilder_.Append("Longitude=").Append(System.Uri.EscapeDataString(longitude.Value.ToString())).Append("&");
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task FilterAsync(System.Collections.Generic.IEnumerable<string> currentStates, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (currentStates != null) foreach (var item_ in currentStates) { urlBuilder_.Append("currentStates=").Append(System.Uri.EscapeDataString(item_.ToString())).Append("&"); }
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<string>> ReverseAsync(System.Collections.Generic.IEnumerable<string> values, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (values != null) foreach (var item_ in values) { urlBuilder_.Append("values=").Append(System.Uri.EscapeDataString(item_.ToString())).Append("&"); }
            urlBuilder_.Length--;
    ...
    public partial class PersonsClient 
    {
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Person>> FindAsync(Gender gender, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Replace("{gender}", System.Uri.EscapeDataString(gender.ToString()));
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<Person>> FindOptionalAsync(Gender? gender, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (gender != null) urlBuilder_.Append("gender=").Append(System.Uri.EscapeDataString(gender.Value.ToString())).Append("&");
            urlBuilder_.Length--;
