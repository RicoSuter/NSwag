//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v9.2.6252.26771 (NJsonSchema v8.2.6249.40688) (http://NSwag.org)
// </auto-generated>
//----------------------
...
namespace NSwag.Integration.Console
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "9.2.6252.26771")]
    public partial class GeoClient 
    {
        ...
        {
            var url_ = string.Format("{0}", "api/Geo/FromBodyTest");
        ...
        {
            var url_ = string.Format("{0}?", "api/Geo/FromUriTest");
        ...
        {
            var url_ = string.Format("{0}", "api/Geo/AddPolygon");
        ...
        {
            var url_ = string.Format("{0}?", "api/Geo/Filter");
        ...
        {
            var url_ = string.Format("{0}?", "api/Geo/Reverse");
        ...
        {
            var url_ = string.Format("{0}", "api/Geo/Refresh");
        ...
        {
            var url_ = string.Format("{0}", "api/Geo/UploadFile");
        ...
        {
            var url_ = string.Format("{0}", "api/Geo/UploadFiles");
        ...
        {
            var url_ = string.Format("{0}", "api/Geo/SaveItems");
        ...
        {
            var url_ = string.Format("{0}?", "api/Geo/GetUploadedFile/{id}");
    ...
    public partial class PersonsClient 
    {
        ...
        {
            var url_ = string.Format("{0}", "api/Persons");
        ...
        {
            var url_ = string.Format("{0}", "api/Persons/find/{gender}");
        ...
        {
            var url_ = string.Format("{0}?", "api/Persons/find2");
        ...
        {
            var url_ = string.Format("{0}", "api/Persons/{id}");
        ...
        {
            var url_ = string.Format("{0}?", "api/Persons/Throw");
        ...
        {
            var url_ = string.Format("{0}", "api/Persons/{id}/Name");
        ...
        {
            var url_ = string.Format("{0}", "api/Persons/AddXml");
