...
namespace NSwag.Integration.Console
{
    ...
    [GeneratedCode("NSwag", "6.5.6124.18922")]
    ...
    internal class JsonExceptionConverter : JsonConverter
    {
        ...
        {
            _searchedNamespaces = new Dictionary<string, Assembly> { { typeof(FileParameter).Name, typeof(FileParameter).GetTypeInfo().Assembly } };
        }
