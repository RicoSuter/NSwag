        ...
        public async System.Threading.Tasks.Task FromBodyTestAsync(GeoPoint location, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var client_ = _httpClient;
            {
                ...
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
            }
        }
        ...
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<string>> ReverseAsync(System.Collections.Generic.IEnumerable<string> values, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var client_ = _httpClient;
            {
                ...
                if (status_ == "200") 
                {
                    ...
                    {
                        throw new SwaggerException("Could not deserialize the response body.", status_, response_, exception);
                    }
                }
                else
                if (status_ != "200" && status_ != "204")
        ...
        public async System.Threading.Tasks.Task SaveItemsAsync(GenericRequestOfAddressAndPerson request, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var client_ = _httpClient;
            {
                ...
                if (status_ == "450") 
                {
                    ...
                    throw new SwaggerException<System.Exception>("A custom error occured.", status_, response_, result_, result_);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
        ...
        public async System.Threading.Tasks.Task<Person> GetAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var client_ = _httpClient;
            {
                ...
                if (status_ == "500") 
                {
                    ...
                    result_.Data.Add("HttpStatus", status_);
                    result_.Data.Add("ResponseData", System.Text.Encoding.UTF8.GetString(responseData_, 0, responseData_.Length));
                    throw new SwaggerException<PersonNotFoundException>("A server side error occurred.", status_, response_, result_, result_);
                }
                else
                if (status_ != "200" && status_ != "204")
                    throw new SwaggerException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", status_, response_, null);
