...
let GeoClient = class GeoClient extends MyBaseClass {
    ...
    fromBodyTest(location) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processFromBodyTest(response)));
                }
                catch (e) {
    ...
    fromUriTest(latitude, longitude) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processFromUriTest(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    addPolygon(points) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processAddPolygon(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    filter(currentStates) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processFilter(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    reverse(values) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processReverse(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    refresh() {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processRefresh(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    uploadFile(file) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processUploadFile(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    uploadFiles(files) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processUploadFiles(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    saveItems(request) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processSaveItems(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    getUploadedFile(id, override) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processGetUploadedFile(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
...
let PersonsClient = class PersonsClient extends MyBaseClass {
    constructor(http, baseUrl) {
        super();
        this.http = null;
        this.baseUrl = undefined;
    ...
    getAll() {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processGetAll(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    add(person) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processAdd(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    find(gender) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processFind(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    findOptional(gender) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processFindOptional(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    get(id) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processGet(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    delete(id) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processDelete(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    throw(id) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processThrow(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    getName(id) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processGetName(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
    ...
    addXml(person) {
        ...
        return Observable_1.Observable.fromPromise(this.transformOptions(options_)).concatMap(transformedOptions_ => {
            ...
            if (response instanceof http_1.Response) {
                try {
                    return Observable_1.Observable.of(this.transformResult(url_, response, (response) => this.processAddXml(response)));
                }
                catch (e) {
                    return Observable_1.Observable.throw(e);
                }
...
PersonsClient = __decorate([
    core_1.Injectable(),
    __param(0, core_1.Inject(http_1.Http)), __param(1, core_1.Optional()), __param(1, core_1.Inject(exports.API_BASE_URL)),
    __metadata("design:paramtypes", [typeof (_b = typeof http_1.Http !== "undefined" && http_1.Http) === "function" && _b || Object, String])
], PersonsClient);
...
var _a, _b;
//# sourceMappingURL=serviceClientsAngular2.js.map