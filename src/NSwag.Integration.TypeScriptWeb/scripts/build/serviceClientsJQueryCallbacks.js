...
class GeoClient {
    ...
    fromBodyTest(location, onSuccess, onFail) {
    ...
    fromUriTest(latitude, longitude, onSuccess, onFail) {
    ...
    addPolygon(points, onSuccess, onFail) {
    ...
    filter(currentStates, onSuccess, onFail) {
    ...
    reverse(values, onSuccess, onFail) {
    ...
    uploadFile(file, onSuccess, onFail) {
    ...
    uploadFiles(files, onSuccess, onFail) {
    ...
    saveItems(request, onSuccess, onFail) {
    ...
    getUploadedFile(id, override, onSuccess, onFail) {
...
class PersonsClient {
    ...
    findOptional(gender, onSuccess, onFail) {
    ...
    addXml(person, onSuccess, onFail) {
