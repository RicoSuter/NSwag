...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v9.12.6298.16247 (NJsonSchema v8.24.6298.12169) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class GeoClient extends MyBaseClass {
    ...
    protected processFromBodyTest(_response: Response) {
    ...
    protected processFromUriTest(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processAddPolygon(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processFilter(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processReverse(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processRefresh(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processUploadFile(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processUploadFiles(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processSaveItems(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processGetUploadedFile(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
...
export class PersonsClient extends MyBaseClass {
    ...
    protected processGetAll(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processAdd(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processFind(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processFindOptional(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processGet(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processDelete(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processThrow(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processGetName(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
    ...
    protected processAddXml(_response: Response) {
        const _responseText = _response.text();
        const _status = _response.status; 
