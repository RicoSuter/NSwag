...
export class GeoClient {
    ...
    filter(currentStates: string[] | null): ng.IPromise<void> {
    ...
    reverse(values: string[] | null): ng.IPromise<string[] | null> {
    ...
    uploadFile(file: FileParameter | null): ng.IPromise<boolean | null> {
    ...
    protected processUploadFile(response: any): ng.IPromise<boolean | null> {
        const status = response.status; 
    ...
    uploadFiles(files: FileParameter[] | null): ng.IPromise<void> {
    ...
    protected processSaveItems(response: any): ng.IPromise<void> {
        ...
        if (status === 204) {
            ...
            return throwException(this.q, "A server error occurred.", status, _responseText, result450);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException(this.q, "An unexpected server error occurred.", status, _responseText);
        }
    ...
    getUploadedFile(id: number, override: boolean): ng.IPromise<FileResponse | null> {
    ...
    protected processGetUploadedFile(response: any): ng.IPromise<FileResponse | null> {
        ...
        if (status === 200 || status === 206) {
            ...
            return this.q.resolve({ fileName: fileName, status: status, data: new Blob([response]), headers: {} });
        } else if (status !== 200 && status !== 204) {
    ...
    postDouble(value: number | null): ng.IPromise<number | null> {
...
export class PersonsClient {
    ...
    protected processGet(response: any): ng.IPromise<Person | null> {
        ...
        if (status === 500) {
            ...
            return throwException(this.q, "A server error occurred.", status, _responseText, result500);
        } else if (status === 200) {
            const _responseText = response.data;
            let result200: Person | null = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
