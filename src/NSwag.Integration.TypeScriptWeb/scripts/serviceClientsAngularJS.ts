...
export class GeoClient {
    ...
    protected processFromBodyTest(_response: any): null | null {
    ...
    protected processFromUriTest(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processAddPolygon(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processFilter(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processReverse(_response: any): string[] | null {
        const _status = _response.status; 
    ...
    protected processRefresh(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processUploadFile(_response: any): boolean | null {
        const _status = _response.status; 
    ...
    protected processUploadFiles(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processSaveItems(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processGetUploadedFile(_response: any): Blob | null {
        const _status = _response.status; 

        if (_status === 200) {
            return new Blob([_response.data], { type: "application/octet-stream" });
        } else if (_status !== 200 && _status !== 204) {
            const _responseText = _response.text();
            return this.throwException("An unexpected server error occurred.", _status, _responseText);
        }
...
export class PersonsClient {
    ...
    protected processGetAll(_response: any): Person[] | null {
        const _status = _response.status; 
    ...
    protected processAdd(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processFind(_response: any): Person[] | null {
        const _status = _response.status; 
    ...
    protected processFindOptional(_response: any): Person[] | null {
        const _status = _response.status; 
    ...
    protected processGet(_response: any): Person | null {
        const _status = _response.status; 
    ...
    protected processDelete(_response: any): null | null {
        const _status = _response.status; 
    ...
    protected processThrow(_response: any): Person | null {
        const _status = _response.status; 
    ...
    protected processGetName(_response: any): string | null {
        const _status = _response.status; 
    ...
    protected processAddXml(_response: any): string | null {
        const _status = _response.status; 
