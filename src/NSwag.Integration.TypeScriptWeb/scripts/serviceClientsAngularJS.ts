...
export class GeoClient {
    ...
    protected processFromBodyTest(response: any): ng.IPromise<void> {
        ...
        if (status === 204) {
            ...
            const responseText = response.data;
            return throwException(this.q, "An unexpected server error occurred.", status, responseText);
        }
        return this.q.resolve<void>(<any>null);
    }
    ...
    protected processSaveItems(response: any): ng.IPromise<void> {
        ...
        if (status === 204) {
            ...
            return throwException(this.q, "A server error occurred.", status, responseText, result450);
        } else if (status !== 200 && status !== 204) {
            const responseText = response.data;
            return throwException(this.q, "An unexpected server error occurred.", status, responseText);
        }
    ...
    protected processGetUploadedFile(response: any): ng.IPromise<Blob | null> {
        const status = response.status; 
...
export class PersonsClient {
    ...
    protected processGet(response: any): ng.IPromise<Person | null> {
        ...
        if (status === 200) {
            ...
            return throwException(this.q, "A server error occurred.", status, responseText, result500);
        } else if (status !== 200 && status !== 204) {
            const responseText = response.data;
            return throwException(this.q, "An unexpected server error occurred.", status, responseText);
        }
