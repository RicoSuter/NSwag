...
export class GeoClient {
    ...
    protected processFromBodyTest(_response: Response): Promise<void> {
    ...
    protected processFromUriTest(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processAddPolygon(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processFilter(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processRefresh(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processUploadFiles(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processSaveItems(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
...
export class PersonsClient {
    ...
    protected processAdd(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return;
