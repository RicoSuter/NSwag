...
export class GeoClient {
    ...
    fromBodyTest(location: GeoPoint): Promise<null | null> {
    ...
    protected processFromBodyTest(_response: Response): Promise<null | null> {
    ...
    fromUriTest(latitude: number, longitude: number): Promise<null | null> {
    ...
    protected processFromUriTest(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    addPolygon(points: GeoPoint[]): Promise<null | null> {
    ...
    protected processAddPolygon(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    filter(currentStates: string[]): Promise<null | null> {
    ...
    protected processFilter(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    protected processReverse(_response: Response): Promise<string[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    protected processRefresh(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    protected processUploadFile(_response: Response): Promise<boolean | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    uploadFiles(files: FileParameter[]): Promise<null | null> {
    ...
    protected processUploadFiles(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    saveItems(request: GenericRequestOfAddressAndPerson): Promise<null | null> {
    ...
    protected processSaveItems(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    getUploadedFile(id: number, override: boolean): Promise<Blob | null> {
...
export class PersonsClient {
    ...
    protected processGetAll(_response: Response): Promise<Person[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
    ...
    add(person: Person): Promise<null | null> {
        let url_ = this.baseUrl + "/api/Persons";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processAdd(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    protected processFind(_response: Response): Promise<Person[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Person[] | null = null;
    ...
    protected processFindOptional(_response: Response): Promise<Person[] | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Person[] | null = null;
    ...
    protected processGet(_response: Response): Promise<Person | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Person | null = null;
    ...
    delete(id: string): Promise<null | null> {
        let url_ = this.baseUrl + "/api/Persons/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
    ...
    protected processDelete(_response: Response): Promise<null | null> {
        const _status = _response.status;
        if (_status === 204) {
            return _response.text().then((_responseText) => {
            return null;
    ...
    protected processThrow(_response: Response): Promise<Person | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: Person | null = null;
    ...
    protected processGetName(_response: Response): Promise<string | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: string | null = null;
    ...
    protected processAddXml(_response: Response): Promise<string | null> {
        const _status = _response.status;
        if (_status === 200) {
            return _response.text().then((_responseText) => {
            let result200: string | null = null;
