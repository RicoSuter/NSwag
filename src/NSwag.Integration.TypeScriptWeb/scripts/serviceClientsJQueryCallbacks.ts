...
export class GeoClient {
    ...
    uploadFile(file: any, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void) {
    ...
    uploadFiles(files: any[], onSuccess?: () => void, onFail?: (exception: string, reason: string) => void) {
