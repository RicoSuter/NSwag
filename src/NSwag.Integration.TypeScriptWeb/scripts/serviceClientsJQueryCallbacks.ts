...
export class GeoClient {
    ...
    addPolygon(points: GeoPoint[] | null, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    filter(currentStates: string[] | null, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    reverse(values: string[] | null, onSuccess?: (result: string[] | null) => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    protected processReverse(xhr: any): string[] | null {
        const status = xhr.status;
    ...
    uploadFile(file: FileParameter | null, onSuccess?: (result: boolean) => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    uploadFiles(files: FileParameter[] | null, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    saveItems(request: GenericRequestOfAddressAndPerson | null, onSuccess?: () => void, onFail?: (exception: Exception | string, reason: string) => void): JQueryXHR {
    ...
    protected processGetUploadedFile(xhr: any): any | null {
        const status = xhr.status;
    ...
    postDouble(value: number | null, onSuccess?: (result: number | null) => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    protected processPostDouble(xhr: any): number | null {
        const status = xhr.status;
...
export class PersonsClient {
    ...
    protected processGetAll(xhr: any): Person[] | null {
        const status = xhr.status;
    ...
    add(person: Person | null, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
        let url_ = this.baseUrl + "/api/Persons";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processFind(xhr: any): Person[] | null {
        const status = xhr.status;
    ...
    protected processFindOptional(xhr: any): Person[] | null {
        const status = xhr.status;
    ...
    protected processGet(xhr: any): Person | null {
        const status = xhr.status;
    ...
    transform(person: Person | null, onSuccess?: (result: Person | null) => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    protected processTransform(xhr: any): Person | null {
        const status = xhr.status;
    ...
    addXml(person: string | null, onSuccess?: (result: string | null) => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    protected processAddXml(xhr: any): string | null {
        const status = xhr.status;
    ...
    upload(data: string | null, onSuccess?: (result: string | null) => void, onFail?: (exception: string, reason: string) => void): JQueryXHR {
    ...
    protected processUpload(xhr: any): string | null {
        const status = xhr.status;
