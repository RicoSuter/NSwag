...
export class GeoClient {
    ...
    uploadFile(file: FileParameter, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void) {
    ...
    saveItems(request: GenericRequestOfAddressAndPerson, onSuccess?: () => void, onFail?: (exception: string, reason: string) => void) {
