...
export class GeoClient {
    ...
    protected processFromBodyTest(_xhr: any): void | null {
    ...
    protected processFromUriTest(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processAddPolygon(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processFilter(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processReverse(_xhr: any): string[] | null | null {
        const _status = _xhr.status; 
    ...
    protected processRefresh(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processUploadFile(_xhr: any): boolean | null | null {
        const _status = _xhr.status; 
    ...
    protected processUploadFiles(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processSaveItems(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processGetUploadedFile(_xhr: any): any | null | null {
        const _status = _xhr.status; 
...
export class PersonsClient {
    ...
    protected processGetAll(_xhr: any): Person[] | null | null {
        const _status = _xhr.status; 
    ...
    protected processAdd(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processFind(_xhr: any): Person[] | null | null {
        const _status = _xhr.status; 
    ...
    protected processFindOptional(_xhr: any): Person[] | null | null {
        const _status = _xhr.status; 
    ...
    protected processGet(_xhr: any): Person | null | null {
        const _status = _xhr.status; 
    ...
    protected processDelete(_xhr: any): void | null {
        const _status = _xhr.status; 
    ...
    protected processThrow(_xhr: any): Person | null | null {
        const _status = _xhr.status; 
    ...
    protected processGetName(_xhr: any): string | null | null {
        const _status = _xhr.status; 
    ...
    protected processAddXml(_xhr: any): string | null | null {
        const _status = _xhr.status; 
