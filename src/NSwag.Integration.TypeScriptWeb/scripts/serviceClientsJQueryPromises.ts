...
export class GeoClient {
    ...
    filter(currentStates: string[] | null) {
        return new Promise<void>((resolve, reject) => {
            this.filterWithCallbacks(currentStates, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }
    
    private filterWithCallbacks(currentStates: string[] | null, onSuccess?: (result: void) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    reverse(values: string[] | null) {
        return new Promise<string[] | null>((resolve, reject) => {
            this.reverseWithCallbacks(values, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }
    
    private reverseWithCallbacks(values: string[] | null, onSuccess?: (result: string[] | null) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    uploadFile(file: FileParameter | null) {
        return new Promise<boolean | null>((resolve, reject) => {
            this.uploadFileWithCallbacks(file, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }
    
    private uploadFileWithCallbacks(file: FileParameter | null, onSuccess?: (result: boolean | null) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    protected processUploadFile(xhr: any): boolean | null | null {
        const status = xhr.status; 
    ...
    uploadFiles(files: FileParameter[] | null) {
        return new Promise<void>((resolve, reject) => {
            this.uploadFilesWithCallbacks(files, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }
    
    private uploadFilesWithCallbacks(files: FileParameter[] | null, onSuccess?: (result: void) => void, onFail?: (exception: string, reason: string) => void) {
    ...
    postDouble(value: number | null) {
        return new Promise<number | null>((resolve, reject) => {
            this.postDoubleWithCallbacks(value, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }
    
    private postDoubleWithCallbacks(value: number | null, onSuccess?: (result: number | null) => void, onFail?: (exception: string, reason: string) => void) {
