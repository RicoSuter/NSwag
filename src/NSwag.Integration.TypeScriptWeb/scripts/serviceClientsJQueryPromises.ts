...
export class PersonsClient {
    ...
    transform(person: Person | undefined) {
        return new Promise<Person | null>((resolve, reject) => {
            this.transformWithCallbacks(person, (result) => resolve(result), (exception, _reason) => reject(exception));
        });
    }
    
    private transformWithCallbacks(person: Person | undefined, onSuccess?: (result: Person | null) => void, onFail?: (exception: string, reason: string) => void) {
