//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v5.6.6108.28584 (NJsonSchema v4.13.6108.28583) (http://NSwag.org)
// </auto-generated>
//----------------------
...
define(["require", "exports"], function (require, exports) {
    ...
    var GeoClient = (function () {
        ...
        GeoClient.prototype.uploadFile = function (file) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.uploadFileWithCallbacks(file, function (result) { return resolve(result); }, function (exception, reason) { return reject(exception); });
            });
        };
        GeoClient.prototype.uploadFileWithCallbacks = function (file, onSuccess, onFail) {
            var _this = this;
            ...
            jQuery.ajax({
                ...
                _this.processUploadFileWithCallbacks(url, xhr, onSuccess, onFail);
            }).fail(function (xhr) {
                _this.processUploadFileWithCallbacks(url, xhr, onSuccess, onFail);
            });
        };
        GeoClient.prototype.processUploadFileWithCallbacks = function (url, xhr, onSuccess, onFail) {
            try {
        ...
        GeoClient.prototype.processUploadFile = function (xhr) {
            var data = xhr.responseText;
            var status = xhr.status.toString();
            if (status === "204") {
                var result204 = undefined;
        ...
        GeoClient.prototype.uploadFiles = function (files) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.uploadFilesWithCallbacks(files, function (result) { return resolve(result); }, function (exception, reason) { return reject(exception); });
            });
        };
        GeoClient.prototype.uploadFilesWithCallbacks = function (files, onSuccess, onFail) {
            var _this = this;
            ...
            jQuery.ajax({
                ...
                _this.processUploadFilesWithCallbacks(url, xhr, onSuccess, onFail);
            }).fail(function (xhr) {
                _this.processUploadFilesWithCallbacks(url, xhr, onSuccess, onFail);
            });
        };
        GeoClient.prototype.processUploadFilesWithCallbacks = function (url, xhr, onSuccess, onFail) {
            try {
        ...
        GeoClient.prototype.processUploadFiles = function (xhr) {
            var data = xhr.responseText;
            var status = xhr.status.toString();
            if (status === "204") {
                var result204 = undefined;
        ...
        GeoClient.prototype.saveItems = function (request) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.saveItemsWithCallbacks(request, function (result) { return resolve(result); }, function (exception, reason) { return reject(exception); });
            });
        };
        GeoClient.prototype.saveItemsWithCallbacks = function (request, onSuccess, onFail) {
            var _this = this;
            ...
            jQuery.ajax({
                ...
                _this.processSaveItemsWithCallbacks(url, xhr, onSuccess, onFail);
            }).fail(function (xhr) {
                _this.processSaveItemsWithCallbacks(url, xhr, onSuccess, onFail);
            });
        };
        GeoClient.prototype.processSaveItemsWithCallbacks = function (url, xhr, onSuccess, onFail) {
            try {
                var result = this.processSaveItems(xhr);
                if (onSuccess !== undefined)
                    onSuccess(result);
            }
            catch (e) {
        ...
        GeoClient.prototype.processSaveItems = function (xhr) {
            var data = xhr.responseText;
            var status = xhr.status.toString();
            if (status === "204") {
                var result204 = undefined;
        ...
        GeoClient.prototype.getUploadedFile = function (id) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.getUploadedFileWithCallbacks(id, function (result) { return resolve(result); }, function (exception, reason) { return reject(exception); });
            });
        };
        GeoClient.prototype.getUploadedFileWithCallbacks = function (id, onSuccess, onFail) {
            var _this = this;
            var url = this.baseUrl + "/api/Geo/GetUploadedFile/{id}";
            ...
            jQuery.ajax({
                ...
                _this.processGetUploadedFileWithCallbacks(url, xhr, onSuccess, onFail);
            }).fail(function (xhr) {
                _this.processGetUploadedFileWithCallbacks(url, xhr, onSuccess, onFail);
            });
        };
        GeoClient.prototype.processGetUploadedFileWithCallbacks = function (url, xhr, onSuccess, onFail) {
            try {
                var result = this.processGetUploadedFile(xhr);
                if (onSuccess !== undefined)
                    onSuccess(result);
            }
            catch (e) {
        ...
        GeoClient.prototype.processGetUploadedFile = function (xhr) {
            var data = xhr.responseText;
            var status = xhr.status.toString();
            if (status === "200") {
                var result200 = null;
    ...
    var PersonsClient = (function () {
        ...
        PersonsClient.prototype.find = function (gender) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.findWithCallbacks(gender, function (result) { return resolve(result); }, function (exception, reason) { return reject(exception); });
            });
        };
        PersonsClient.prototype.findWithCallbacks = function (gender, onSuccess, onFail) {
            var _this = this;
            ...
            jQuery.ajax({
                ...
                _this.processFindWithCallbacks(url, xhr, onSuccess, onFail);
            }).fail(function (xhr) {
                _this.processFindWithCallbacks(url, xhr, onSuccess, onFail);
            });
        };
        PersonsClient.prototype.processFindWithCallbacks = function (url, xhr, onSuccess, onFail) {
            try {
        ...
        PersonsClient.prototype.processFind = function (xhr) {
            var data = xhr.responseText;
            var status = xhr.status.toString();
            if (status === "200") {
                var result200 = null;
        ...
        PersonsClient.prototype.find2 = function (gender) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                _this.find2WithCallbacks(gender, function (result) { return resolve(result); }, function (exception, reason) { return reject(exception); });
            });
        };
        PersonsClient.prototype.find2WithCallbacks = function (gender, onSuccess, onFail) {
            var _this = this;
            ...
            jQuery.ajax({
                ...
                _this.processFind2WithCallbacks(url, xhr, onSuccess, onFail);
            }).fail(function (xhr) {
                _this.processFind2WithCallbacks(url, xhr, onSuccess, onFail);
            });
        };
        PersonsClient.prototype.processFind2WithCallbacks = function (url, xhr, onSuccess, onFail) {
            try {
        ...
        PersonsClient.prototype.processFind2 = function (xhr) {
            var data = xhr.responseText;
            var status = xhr.status.toString();
            if (status === "200") {
                var result200 = null;
