//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v5.6.6109.17368 (NJsonSchema v4.14.6108.28115) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class GeoClient {
    ...
    private getUploadedFileWithCallbacks(id: number, onSuccess?: (result: any) => void, onFail?: (exception: string, reason: string) => void) {
        let url = this.baseUrl + "/api/Geo/GetUploadedFile/{id}"; 
        ...
        jQuery.ajax({
            ...
            this.processGetUploadedFileWithCallbacks(url, xhr, onSuccess, onFail);
        }).fail((xhr) => {
            this.processGetUploadedFileWithCallbacks(url, xhr, onSuccess, onFail);
        });
    }
