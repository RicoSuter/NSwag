...
export class Client {
    ...
    protected processAddPet(_response: Response) {
    ...
    protected processUpdatePet(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 400) {
                this.throwException("A server error occurred.", _status, _responseText);
    ...
    protected processFindPetsByStatus(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
    ...
    protected processFindPetsByTags(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
                let result200: Pet[] | null = null;
    ...
    protected processGetPetById(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
                let result200: Pet | null = null;
    ...
    protected processUpdatePetWithForm(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 405) {
                this.throwException("A server error occurred.", _status, _responseText);
     ...
     */
    deletePet(api_key: string, petId: number) {
        let url_ = this.baseUrl + "/pet/{petId}";
        if (petId === undefined || petId === null)
            throw new Error("The parameter 'petId' must be defined.");
        url_ = url_.replace("{petId}", encodeURIComponent("" + petId)); 
    ...
    protected processDeletePet(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 400) {
                this.throwException("A server error occurred.", _status, _responseText);
     ...
     * @return successful operation
     */
    uploadFile(petId: number, additionalMetadata: string, file: FileParameter) {
    ...
    protected processGetInventory(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
    ...
    protected processPlaceOrder(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
    ...
    protected processGetOrderById(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
                let result200: Order | null = null;
    ...
    protected processDeleteOrder(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 400) {
                this.throwException("A server error occurred.", _status, _responseText);
    ...
    protected processCreateUser(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            {
                return null;
    ...
    protected processCreateUsersWithArrayInput(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            {
                return null;
    ...
    protected processCreateUsersWithListInput(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            {
                return null;
    ...
    protected processLoginUser(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
    ...
    protected processLogoutUser(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            {
                return null;
    ...
    protected processGetUserByName(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 200) {
    ...
    protected processUpdateUser(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 400) {
                this.throwException("A server error occurred.", _status, _responseText);
    ...
    protected processDeleteUser(_response: Response) {
        return _response.text().then((_responseText) => {
            const _status = _response.status;
            if (_status === 400) {
                this.throwException("A server error occurred.", _status, _responseText);
