...
//----------------------
// <auto-generated>
//     Generated using the NSwag toolchain v7.7.6175.17576 (NJsonSchema v5.19.6171.28316) (http://NSwag.org)
// </auto-generated>
//----------------------
...
export class Client {
    ...
    private processAddPet(response: Response) {
    ...
    private processUpdatePet(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processFindPetsByStatus(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processFindPetsByTags(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processGetPetById(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processUpdatePetWithForm(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processDeletePet(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processGetInventory(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processPlaceOrder(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processGetOrderById(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processDeleteOrder(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processCreateUser(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processCreateUsersWithArrayInput(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processCreateUsersWithListInput(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processLoginUser(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processLogoutUser(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processGetUserByName(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processUpdateUser(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
    ...
    private processDeleteUser(response: Response) {
        return response.text().then((responseText) => {
            const status = response.status; 
