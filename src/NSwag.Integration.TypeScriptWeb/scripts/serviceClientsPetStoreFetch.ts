...
export class Client {
     ...
     * @return successful operation
     */
    findPetsByStatus(status: Status[]): Promise<FileResponse> {
    ...
    protected processFindPetsByStatus(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
     ...
     * @deprecated
     */
    findPetsByTags(tags: string[]): Promise<FileResponse> {
    ...
    protected processFindPetsByTags(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    getPetById(petId: number): Promise<FileResponse> {
    ...
    protected processGetPetById(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    placeOrder(body: Order): Promise<FileResponse> {
    ...
    protected processPlaceOrder(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    getOrderById(orderId: number): Promise<FileResponse> {
    ...
    protected processGetOrderById(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    createUsersWithArrayInput(body: User[]): Promise<FileResponse> {
    ...
    protected processCreateUsersWithArrayInput(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    createUsersWithListInput(body: User[]): Promise<FileResponse> {
    ...
    protected processCreateUsersWithListInput(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    getUserByName(username: string): Promise<FileResponse> {
    ...
    protected processGetUserByName(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    loginUser(username: string, password: string): Promise<FileResponse> {
    ...
    protected processLoginUser(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    logoutUser(): Promise<FileResponse> {
    ...
    protected processLogoutUser(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     * @return successful operation
     */
    createUser(body: User): Promise<FileResponse> {
