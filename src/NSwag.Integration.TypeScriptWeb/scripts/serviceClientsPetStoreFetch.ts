...
export class Client {
    ...
    protected processAddPet(_response: Response): Promise<void> {
    ...
    protected processUpdatePet(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 400) {
            return _response.text().then((_responseText) => {
            return throwException("A server error occurred.", _status, _responseText);
    ...
    protected processFindPetsByStatus(_response: Response): Promise<Pet[] | null> {
        ...
        return Promise.resolve<Pet[] | null>(<any>null);
    }
    ...
    protected processUpdatePetWithForm(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 405) {
            return _response.text().then((_responseText) => {
            return throwException("A server error occurred.", _status, _responseText);
    ...
    protected processDeletePet(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 400) {
            return _response.text().then((_responseText) => {
            return throwException("A server error occurred.", _status, _responseText);
    ...
    protected processUploadFile(_response: Response): Promise<ApiResponse | null> {
        ...
        return Promise.resolve<ApiResponse | null>(<any>null);
    }
    ...
    protected processGetInventory(_response: Response): Promise<{ [key: string] : number; } | null> {
        ...
        return Promise.resolve<{ [key: string] : number; } | null>(<any>null);
    }
    ...
    protected processPlaceOrder(_response: Response): Promise<Order | null> {
        ...
        return Promise.resolve<Order | null>(<any>null);
    }
    ...
    protected processDeleteOrder(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 400) {
            return _response.text().then((_responseText) => {
            return throwException("A server error occurred.", _status, _responseText);
    ...
    protected processCreateUser(_response: Response): Promise<void> {
        const _status = _response.status;
        {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processCreateUsersWithArrayInput(_response: Response): Promise<void> {
        const _status = _response.status;
        {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processCreateUsersWithListInput(_response: Response): Promise<void> {
        const _status = _response.status;
        {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processLogoutUser(_response: Response): Promise<void> {
        const _status = _response.status;
        {
            return _response.text().then((_responseText) => {
            return;
    ...
    protected processUpdateUser(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 400) {
            return _response.text().then((_responseText) => {
            return throwException("A server error occurred.", _status, _responseText);
    ...
    protected processDeleteUser(_response: Response): Promise<void> {
        const _status = _response.status;
        if (_status === 400) {
            return _response.text().then((_responseText) => {
            return throwException("A server error occurred.", _status, _responseText);
