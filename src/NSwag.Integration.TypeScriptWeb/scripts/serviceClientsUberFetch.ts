...
export class Client {
     ...
     * @return An array of products
     */
    time(start_latitude: number, start_longitude: number, customer_uuid: string | null, product_id: string | null): Promise<Product[] | null> {
     ...
     */
    history(offset: number | null, limit: number | null): Promise<Activities | null> {
