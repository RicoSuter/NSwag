...
export class Client {
    ...
    protected processProducts(response: Response): Promise<Product[]> {
        ...
        if (status === 200) {
            ...
            resultdefault = resultDatadefault ? ErrorDto.fromJS(resultDatadefault) : new ErrorDto();
    ...
    protected processMe(response: Response): Promise<Profile> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Profile.fromJS(resultData200) : new Profile();
            return result200;
            });
        } else {
            return response.text().then((_responseText) => {
    ...
    protected processHistory(response: Response): Promise<Activities> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? Activities.fromJS(resultData200) : new Activities();
            return result200;
            });
        } else {
            return response.text().then((_responseText) => {
