...
export class DateService extends ServiceBase {
    ...
    addDays(date: moment.Moment, days: number): Observable<moment.Moment | null> {
    ...
    protected processAddDays(response: Response): Observable<moment.Moment | null> {
        const status = response.status; 

        let _headers: any = response.headers ? response.headers.toJSON() : {};
        if (status === 200) {
            const _responseText = response.text();
            let result200: moment.Moment | null = null;
    ...
    getDayOfYear(date: moment.Moment): Observable<number | null> {
    ...
    protected processGetDayOfYear(response: Response): Observable<number | null> {
        const status = response.status; 
...
export class SampleDataService extends ServiceBase {
    ...
    protected processGetRoles(response: Response): Observable<moment.Moment[] | null> {
        const status = response.status; 
